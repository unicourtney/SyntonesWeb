...
public class FTPUploader {
	...
	public String uploadFile(String localFileFullName, String fileName,String hostDir) throws Exception {
	...
	// FTPUploader ftpUploader = new FTPUploader("ftp.journaldev.com",
	// "ftpUser", "ftpPassword");
