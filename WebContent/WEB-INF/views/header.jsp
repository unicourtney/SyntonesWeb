...
<!-- Graph CSS -->
<link href="<%=request.getContextPath()%>/resources/css/lines.css" rel='stylesheet' type='text/css' />
...
<script src="<%=request.getContextPath()%>/resources/js/rickshaw.js"></script>
</head>
	...
	<div id="wrapper">
        ...
        <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <a class="navbar-brand" href="#">SYNTONES</a>
            </div>
             <!-- /.navbar-header -->
            <ul class="nav navbar-nav navbar-right">
            	<li>
            		<a href="index">Songs</a>
            	</li>
            	<li>
            		<a href="logoutAdmin">Logout as ${username}</a>
            	</li>
            </ul>
		</div>
	</div>
